...
args = TrainerState(
    ...
    fp16=False,
    #use_adv='pgd',
    save_path="S:/bert4torch/experiments/outputs/text_classify_tnews",
    model_path="S:/bert4torch/resources/NEZHA",
    data_dir="S:/bert4torch/datasets/tnews/"
)
...
model = ClsModel()
trainer = Trainer(model, args, train_dataset, dev_data=dev_dataset, test_data=test_dataset, validate_every=50, loss='focal',
...
if __name__ == "__main__":
    ...
    trainer.test('best_ClsModel_accuracy')

# dev
# AccuracyMetric: accuracy=0.89538
# ClassifyFPreRecMetric: f1=0.895392, precision=0.895403, recall=0.89538
# test
# {'accuracy': 0.89538}
# {'f1': 0.895392, 'precision': 0.895403, 'recall': 0.89538}


# {'accuracy': 0.894936}
# {'f1': 0.894947, 'precision': 0.894959, 'recall': 0.894936}
# {'loss': 0.3730874}
